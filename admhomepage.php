               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        <li><a class="active" href="admhomepage.php">Home</a></li>
                        <li><a data-scroll href="hospital.html">Hospital</a></li>
                        <li><a data-scroll href="vd.html">View Donors</a></li>
                        <li><a data-scroll href="uor.php">Update Request Status</a></li>
                        <li><a data-scroll href="achangepass.html">Change Password</a></li>
                        <li><a data-scroll href="alogout.php">Logout</a></li>
                     </ul>
                  </div>
               </nav>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     ...
                     <h2>Welcome Admin</h2>
                     <p class="lead">It is a Web application through which user can register and login and can raise the request for Organ Donation in a particular Hospital.</p>
                     <p>Even User can request for organs which has to be approved by Admin and available hospital.</p>
