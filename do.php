               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a class="active"data-scroll href="do.php">Donate Organs</a></li>
                        <li><a data-scroll href="ro.php">Request Organ</a></li>
                        <li><a data-scroll href="rs.php">Request Status</a></li>
                        <li><a data-scroll href="update.php">Update Info.</a></li>
						<li><a data-scroll href="changepass.html">Change Password</a></li>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     ...
                     <p>
					 <form name="f" method="post" action="do1.php">
						

						<div class="form-group">
							<label>Select Organ Type:
							<select class="form-control" name="t1">
							<option value="Cornea">Cornea
							<option value="Heart-Valves">Heart Valves
							<option value="Skin">Skin
							<option value="Bone">Bone
							<option value="Heart">Heart
							<option value="Liver">Liver
							<option value="Kidney">Kidney
							<option value="Lungs">Lungs
							<option value="Pancreas">Pancreas
							</select>
						</div>
						
						<div class="form-group">
							
							<input type="text" class="form-control" name="t2" placeholder="Family Member Name">
						</div>
						<div class="form-group">
							
							<input type="number" class="form-control" name="t3" placeholder="Family Member Contact Number">
						</div>
