               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        <li><a class="active" href="hhomepage.php">Home</a></li>
                        <li><a data-scroll href="hvd.html">View Donors</a></li>
                        <li><a data-scroll href="hur.php">Update Request Status</a></li>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
					 ...
					 <form name="f" method="post" action="hur2.php">
							...
							<textarea rows=4 cols=10 class="form-control" name="t6"></textarea>
