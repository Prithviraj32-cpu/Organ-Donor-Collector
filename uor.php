               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        <li><a href="admhomepage.php">Home</a></li>
                        <li><a data-scroll href="hospital.html">Hospital</a></li>
                        <li><a data-scroll href="vd.html">View Donors</a></li>
                        <li><a  class="active" data-scroll href="uor.php">Update Request Status</a></li>
               ...
               <table id="customers" border="1" cellpadding="5" cellspacing="5">
				  ...
				  <th>Organ Request ID
					...
					while($row = $result->fetch_assoc())
					{
						...
						echo "<td>".$pdesc;
						echo "<td>".$ucno;
						echo "<td><a href='uor1.php?id=".$orid."'>Update Status</a>";
