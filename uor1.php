               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a data-scroll href="do.php">Donate Organs</a></li>
                        <li><a class="active" data-scroll href="ro.php">Request Organ</a></li>
...
$sql="select * from ordet where orid='$id'";
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
					 ...
					 <form name="f" method="post" action="uor2.php">

								<div class="form-group">
								<label>Organ Request ID:</label>
								...
								<input type="text" class="form-control" name="t4" required value="<?php echo $otype; ?>">
								</div>
								
								<div class="form-group">
								<label>Organ Requested By:</label>
								<input type="text" class="form-control" name="t5" required value="<?php echo $ufname; ?>">
								</div>
