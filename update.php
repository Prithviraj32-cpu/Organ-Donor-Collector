               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a data-scroll href="do.html">Donate Organs</a></li>
                        <li><a data-scroll href="ro.html">Request Organ</a></li>
                        <li><a data-scroll href="rs.php">Request Status</a></li>
                        <li><a  class="active" data-scroll href="update.php">Update Info.</a></li>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     ...
                     <p><form name="f" method="post" action="update2.php">
