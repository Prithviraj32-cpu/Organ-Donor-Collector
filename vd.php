               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a class="active"  data-scroll href="vd.html">View Donors</a></li>
			 ...
			 <h2>View Donors</h2>
               <table id="customers" border="1" cellpadding="5" cellspacing="5">
				  <tr>
					...
					<th>Contact Number
					<th>Organ Type
					<th>Family Member Name
					<th>Family Member Contact Number
					...
					$sql="select * from donate where otype='$otype'";
